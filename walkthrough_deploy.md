...
1. Sube tu proyecto actual a **GitHub** (creo que lo tienes ya sincronizado en local).
2. Entra en [Koyeb.com](https://app.koyeb.com/) e inicia sesión vinculando tu GitHub.
3. Haz clic en **Create Web Service** -> Selecciona **GitHub**.
4. Elige tu repositorio `FotoRoulette` de la lista.
5. **¡SÚPER IMPORTANTE!** Configuración en Koyeb:
...
6. Dale a **Deploy** en el plan *Eco Free (Nano)*.
7. Espera unos minutos y Koyeb te regalará una URL (ejemplo: `https://fotoroulette-tucuenta.koyeb.app`).

---

### Paso 2: Tu Turno
Cuando Koyeb acabe de hacer magia y el servidor esté "Healthy", dime cuál es tu **URL oficial** aquí por el chat. 
En cuanto me la des, yo actualizaré el código de conexión y dispararemos el comando maestro para crear la APK definitiva de Android.
